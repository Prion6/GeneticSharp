...
namespace GeneticSharp.Domain.UnitTests.Mutations
{
    ...
    class DisplacementMutationTest
    {
        ...
        public void Mutate_ValidChromosome_Displacement_To_Left()
        {
            ...
            Assert.AreEqual(5, chromosome.GetGene(2));
            Assert.AreEqual(6, chromosome.GetGene(3));
            Assert.AreEqual(7, chromosome.GetGene(4));
            Assert.AreEqual(2, chromosome.GetGene(5));
            Assert.AreEqual(3, chromosome.GetGene(6));
        ...
        public void Mutate_ValidChromosome_Displacement_To_Right()
        {
            ...
            Assert.AreEqual(8, chromosome.Length);
            Assert.AreEqual(1, chromosome.GetGene(0));
            Assert.AreEqual(6, chromosome.GetGene(1));
            Assert.AreEqual(7, chromosome.GetGene(2));
            Assert.AreEqual(2, chromosome.GetGene(3));
            Assert.AreEqual(3, chromosome.GetGene(4));
            Assert.AreEqual(4, chromosome.GetGene(5));
            Assert.AreEqual(5, chromosome.GetGene(6));
            Assert.AreEqual(8, chromosome.GetGene(7));
        }
    }
}
